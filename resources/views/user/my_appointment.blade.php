...
<head>
  ...
  <title>HOME | JLN Hospital | AJMER</title>
...
<body>
  ...
  <header>
    ...
    <nav class="navbar navbar-expand-lg navbar-light shadow-sm">
      <div class="container">
        <a class="navbar-brand" href="#"><span class="text-primary">JLN</span>-Hospital</a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupport">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item" style="margin: 4px 0px">
...
<div align="center" style="padding:70px;">
    <table>
        ...
        <tr align="center" style="text-transform:capitalize; text-align:center; justify-content:center;">
